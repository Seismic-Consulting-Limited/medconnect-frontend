...
<div className="my-5 space-y-5">
            ...
            <div className="flex items-center gap-5 lg:justify-between px-5">
              <div className="flex items-center gap-2 border-[0.5px] border-[#D7D7D7] bg-[#EDEDED] rounded-[8px] lg:w-[136px] h-[39px] p-[8px]">
            ...
            <div className='flex items-center justify-between px-5'>
                <Button className='px-[20px] py-[12px] lg:w-[177px] h-[47px] rounded-[12px]'>
                    <Video className='w-[20px] h-[20px]' />
                    Join Video Call
                </Button>
                <Button variant={'outline'} className='px-[20px] py-[12px] lg:w-[107px] h-[47px] rounded-[12px]'>
                    Reschedule
                </Button>
            </div>
          </div>

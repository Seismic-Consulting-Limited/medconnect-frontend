...
export default function ClientSignupPage() {
  ...
  const isPasswordValid =
    passwordValidation.hasUppercase && passwordValidation.hasLowercase && passwordValidation.hasMinLength
              ...
              {password && (
                <div className="text-sm space-y-1">
                  <p className="text-primary">
                    ...
                    , include a mix of{" "}
                    <span className={passwordValidation.hasUppercase ? "text-primary" : "text-primary"}>uppercase</span>{" "}
                    and{" "}
                    <span className={passwordValidation.hasLowercase ? "text-primary" : "text-primary"}>
                      lowercase letters
                    </span>
                    , and be at{" "}
                    <span className={passwordValidation.hasMinLength ? "text-primary" : "text-primary"}>

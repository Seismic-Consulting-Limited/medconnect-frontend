  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
              ...
              <div className="flex flex-col justify-center space-y-6 lg:col-span-5">
                <div className="space-y-4">
                  ...
                  <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter">
                    Join Our Nigerian Healthcare Network
                  </h1>
                  <p className="text-white/80 text-sm sm:text-base md:text-lg max-w-[90%] sm:max-w-[600px]">
                    Connect with international patients seeking quality healthcare and travel services within Nigeria. Expand your
                    ...
                    <div className="bg-white rounded-lg shadow-xl p-4 transform hover:-translate-y-1 transition-transform duration-300">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Leading Nigerian facilities</p> {/* Updated text */}
                        </div>
                      </div>
                    </div>
                    <div className="bg-white rounded-lg shadow-xl p-4 transform hover:-translate-y-1 transition-transform duration-300">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Growing annually</p> {/* Updated text */}
                        </div>
                      </div>
                    </div>
                    <div className="bg-white rounded-lg shadow-xl p-4 transform hover:-translate-y-1 transition-transform duration-300">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="font-medium text-gray-900">International Reach</h3> {/* Updated text */}
                          <p className="text-sm text-gray-500">Patients from abroad</p> {/* Updated text */}
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="bg-white rounded-lg shadow-xl p-4 transform hover:-translate-y-1 transition-transform duration-300">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Trusted Nigerian partners</p> {/* Updated text */}
                        </div>
                      </div>
                    </div>
                    <div className="bg-white rounded-lg shadow-xl p-4 transform hover:-translate-y-1 transition-transform duration-300">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Significant increase</p> {/* Updated text */}
                        </div>
                      </div>
                    </div>
                    <div className="bg-white rounded-lg shadow-xl p-4 transform hover:-translate-y-1 transition-transform duration-300">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Diverse treatment areas</p> {/* Updated text */}
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <ResponsiveContainer>
            <div className="text-center mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold tracking-tighter md:text-4xl mb-4">
                Why Partner With MedConnect in Nigeria?
              </h2>
              <p className="text-gray-600 max-w-[800px] mx-auto">
                Join our network of Nigerian healthcare providers and travel specialists to expand your reach and grow
                your business.
              </p>
            </div>
              ...
              <TabsContent value="hospitals" className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <Card className="border-2 border-primary-50 hover:border-primary-100 transition-all duration-300">
                    <CardHeader className="pb-2">
                      ...
                      <CardTitle>International Patient Access</CardTitle> {/* Updated text */}
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-600">
                        Connect with patients from around the world seeking quality healthcare services in Nigeria.
                      </p>
                    </CardContent>
                  </Card>
                  <Card className="border-2 border-primary-50 hover:border-primary-100 transition-all duration-300">
                    ...
                    <CardContent>
                      <p className="text-gray-600">
                        Boost your facility's occupancy and revenue by tapping into the growing medical tourism market in Nigeria.
                      </p>
                    </CardContent>
                  </Card>
                  <Card className="border-2 border-primary-50 hover:border-primary-100 transition-all duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Card className="border-2 border-primary-50 hover:border-primary-100 transition-all duration-300">
                    ...
                    <CardContent>
                      <p className="text-gray-600">
                        Work with our network of Nigerian travel agents who handle all non-medical aspects of patient journeys,
                  ...
                  <Card className="border-2 border-primary-50 hover:border-primary-100 transition-all duration-300">
                    ...
                    <CardContent>
                      <p className="text-gray-600">
                        Showcase your facilities, specialties, and success stories to international patients seeking care in Nigeria
              ...
              <TabsContent value="agents" className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <Card className="border-2 border-primary-50 hover:border-primary-100 transition-all duration-300">
                    ...
                    <CardContent>
                      <p className="text-gray-600">
                        Focus on the growing medical tourism niche for patients traveling to Nigeria.
                      </p>
                    </CardContent>
                  </Card>
                  <Card className="border-2 border-primary-50 hover:border-primary-100 transition-all duration-300">
                    ...
                    <CardContent>
                      <p className="text-gray-600">
                        Gain direct access to our network of verified Nigerian hospitals and healthcare providers.
                      </p>
                    </CardContent>
                  </Card>
                  <Card className="border-2 border-primary-50 hover:border-primary-100 transition-all duration-300">
                    ...
                    <CardContent>
                      <p className="text-gray-600">
                        Receive high-quality leads from patients who have already selected their medical providers in Nigeria and need travel arrangements.
                      </p>
                    </CardContent>
                  </Card>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Card className="border-2 border-primary-50 hover:border-primary-100 transition-all duration-300">
                    <CardHeader className="pb-2">
                      ...
                      <CardTitle>International Clientele</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-600">
                        Expand your client base internationally with patients seeking medical care in Nigeria who need
        ...
        <section className="w-full py-16 md:py-24 bg-gray-50">
          <ResponsiveContainer>
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-[800px] mx-auto">
                Our streamlined onboarding process gets you connected with patients seeking care in Nigeria quickly and efficiently.
              </p>
            </div>
            <Tabs defaultValue="hospitals" className="w-full">
              <div className="flex justify-center mb-10">
              ...
              <TabsContent value="hospitals">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-gray-600">
                      Begin receiving inquiries and bookings from international patients seeking your services in Nigeria.
                    </p>
                  </div>
                </div>
              </TabsContent>
              <TabsContent value="agents">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-gray-600">
                      Create your agency profile highlighting your services, destinations in Nigeria, and languages.
                    </p>
                  </div>
                  <div className="flex flex-col items-center text-center">
                    <div className="w-16 h-16 rounded-full bg-primary flex items-center justify-center text-white text-xl font-bold mb-4">
                    ...
                    <p className="text-gray-600">
                      Start receiving travel requests from patients who have selected their medical providers in Nigeria.
                    </p>
                  </div>
                </div>
              </TabsContent>
        ...
        {/* Testimonials Section - UPDATED TEXT AND IMAGES */}
        <section className="w-full py-16 md:py-24 bg-white">
          <ResponsiveContainer>
            <div className="text-center mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold tracking-tighter md:text-4xl mb-4">
              ...
              <p className="text-gray-600 max-w-[800px] mx-auto">
                Hear from hospitals and travel agents who have grown their business with MedConnect in Nigeria.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <CardContent className="p-8">
                  <div className="flex flex-col gap-4">
                    <p className="text-gray-600 italic text-lg">
                      "Joining MedConnect has transformed our international patient program. We've seen a significant increase
                      in patients coming to our facility in Lagos, with the platform handling all the initial screening and coordination."
                    </p>
                    <div className="flex items-center gap-4 mt-4">
                      <div className="w-16 h-16 rounded-full bg-gray-200 overflow-hidden">
                        <img src="/placeholder.svg?key=nigerian-doctor-portrait" alt="Hospital Director" className="w-full h-full object-cover" />
                      </div>
                      <div>
                        <p className="font-bold">Dr. Amina Bello</p>
                        <p className="text-gray-500">International Patient Coordinator</p>
                        <p className="text-primary">Lagos Premier Hospital</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="border-2 border-primary-50">
                <CardContent className="p-8">
                  <div className="flex flex-col gap-4">
                    <p className="text-gray-600 italic text-lg">
                      "As a travel agency specializing in medical tourism to Nigeria, MedConnect has been invaluable. The direct
                      connection with verified Nigerian hospitals and pre-qualified patients has streamlined our operations and
                      increased our bookings."
                    </p>
                    <div className="flex items-center gap-4 mt-4">
                      <div className="w-16 h-16 rounded-full bg-gray-200 overflow-hidden">
                        <img src="/placeholder.svg?key=nigerian-travel-agent-portrait" alt="Travel Agency CEO" className="w-full h-full object-cover" />
                      </div>
                      <div>
                        <p className="font-bold">Chidi Okoro</p>
                        <p className="text-gray-500">Founder & CEO</p>
                        <p className="text-primary">Naija Journeys Travel</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
        ...
        {/* FAQ Section with Purple Background - UPDATED TEXT */}
          ...
          <ResponsiveContainer>
            <div className="text-center mb-12">
              ...
              <p className="text-primary-800/80 max-w-[800px] mx-auto">
                Get answers to common questions about joining the MedConnect partner network in Nigeria.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-700">
                    We accept hospitals with JCI, ISO, national healthcare accreditations (e.g., from the Medical and Dental Council of Nigeria), or equivalent quality
              ...
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-700">
                    ...
                    recommendations based on their medical needs, budget, and preferences for care in Nigeria.
                  </p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-sm">
